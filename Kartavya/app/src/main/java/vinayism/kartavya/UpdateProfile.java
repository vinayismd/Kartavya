...
public class UpdateProfile extends ActionBarActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {

    final String LOG = "UpdateProfile";
    EditText name, admno, pwd, year, wrkun, brnch  ,phnno , email;
    Spinner spcentre , spteam;
    String steam , scentre , pickadmno;
    Button register;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spcentre.setOnItemSelectedListener(this);
    ...
    public void onClick(View view) {
        ...
        if (name.getText().toString().trim().equals("") || email.getText().toString().trim().equals("")
            ...
            PostResponseAsyncTask taskreg = new PostResponseAsyncTask(UpdateProfile.this, postdata, new AsyncResponse() {
                @Override
                public void processFinish(String s) {
                    Log.d(LOG, s);
                    if (s.contains("success")) {
                        Toast.makeText(UpdateProfile.this, "INsert Successful", Toast.LENGTH_SHORT).show();
            ...
            taskreg.execute("http://10.0.2.2/kartavya/updateprofile.php");
        }
    }
